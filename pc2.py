...
try:
    if not Path(RESOURCES_DIR + "/Miner_config3.cfg").is_file():
        ...
        try:
            config.read(RESOURCES_DIR + "/Miner_config3.cfg")
...
def loadConfig():
    ...
    if not Path(RESOURCES_DIR + "/Miner_config.cfg3").is_file():
        print(
            Style.BRIGHT
        ...
        with open(RESOURCES_DIR + "/Miner_config.cfg3", "w") as configfile:
