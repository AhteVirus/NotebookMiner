...
try:
    if not Path(RESOURCES_DIR + "/Miner_config4.cfg").is_file():
        ...
        try:
            config.read(RESOURCES_DIR + "/Miner_config4.cfg")
...
def loadConfig():
    ...
    if not Path(RESOURCES_DIR + "/Miner_config4.cfg").is_file():
        ...
        with open(RESOURCES_DIR + "/Miner_config4.cfg", "w") as configfile:
